...
public class SysRoleServiceImpl extends BaseServiceImpl<SysRoleDao, SysRoleEntity> implements SysRoleService {
    ...
    @Override
    public List<SysRoleVO> getShopRoleList() {
        LambdaQueryWrapper<SysRoleEntity> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.like(SysRoleEntity::getRoleCode,"SHOP");
        List<SysRoleEntity> list = list(queryWrapper);
        List<SysRoleVO> sysRoleVOS = SysRoleConvert.INSTANCE.convertList(list);
        return sysRoleVOS;
    }
