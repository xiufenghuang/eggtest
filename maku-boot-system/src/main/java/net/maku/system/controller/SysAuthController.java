...
public class SysAuthController {
    ...
    @PostMapping("wxLogin")
    @Operation(summary = "微信小程序店员登录")
    public Result<SysUserTokenVO> wxLogin(@RequestBody SysAccountLoginVO login){

        SysUserTokenVO token = sysAuthService.loginByWxUser(login);
        return Result.ok(token);
    }
